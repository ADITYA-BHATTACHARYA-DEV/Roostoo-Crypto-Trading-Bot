...
TRADE_PAIR = "BTC/USD"
FETCH_INTERVAL = 2         # Increase interval to reduce rate limit errors
SIMULATION_DURATION = 120  # Run simulation for 120 seconds
...
class SensitiveGridTradingStrategy(TradingStrategy):
    def __init__(self, sensitive_gap=0.005):
        """
...
class SimulationBot:
    ...
    def update_portfolio_value(self, price):
        ...
        self.risk_manager.update_portfolio(value)
        return value
...
def main():
    ...
    # Use the highly sensitive Grid Trading Strategy with a lower gap threshold
